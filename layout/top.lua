...
local top = function(s)     
    ...
    panel_widget:add_widget_at(weather_widget,2,9,2,3)
    panel_widget:add_widget_at(wall_widget,2,14,1,1)
    panel_widget:add_widget_at(tag_switch_widget,2,13,1,1)
    panel_widget:add_widget_at(time_widget,1,6,1,3)
    panel_widget:add_widget_at(motd,1,9,1,3)
