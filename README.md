...
<br/>
<p align='center'>The following images uses the <strong>[Juno](https://github.com/EliverLara/Juno)</strong> GTK3+ theme:</p>
...
<p align='center'>The following images use the <strong>[Nordic]()</strong> GTK3+ theme:</p>
